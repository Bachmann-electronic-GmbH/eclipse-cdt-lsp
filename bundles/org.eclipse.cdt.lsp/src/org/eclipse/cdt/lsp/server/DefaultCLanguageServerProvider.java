...
public class DefaultCLanguageServerProvider implements ICLanguageServerProvider {
	...
	private String compileCommandsDir = DEFAULT_COMPILE_COMMANDS_DIR;
	...
	public String getCompileCommandsDir() {
		return this.compileCommandsDir;
	}

	@Override
	public void setCompileCommandsDir(String path) {
		this.compileCommandsDir = path;	
	}
	...
	private String getCommandOptionsAsString(List<String> commands) {
		...
		for (int i=1; i<commands.size(); i++) {
			options = options + " " + commands.get(i);
		}
		return options;	
	}
}
