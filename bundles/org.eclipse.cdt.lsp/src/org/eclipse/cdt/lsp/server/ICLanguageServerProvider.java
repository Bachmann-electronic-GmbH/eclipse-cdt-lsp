...
public interface ICLanguageServerProvider {
	 ...
	 * 
	 * @return project relative path containing the compile_commands.json
	 */
	public String getCompileCommandsDir();
	
	/**
	 * Sets the path to the directory containing the compile_commands.json file
	 * 
	 * @param path to compile_commands.json
	 */
	public void setCompileCommandsDir(String path);
